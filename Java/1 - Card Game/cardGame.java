...
//Check validity of cards
        ...
        //suit validity
            ...
            //card 1 Suit
            if (c1Suit != 'H' && c1Suit != 'C' && c1Suit != 'D' && c1Suit != 'S' && c1Suit != 'h' && c1Suit != 'c' && c1Suit != 'd' && c1Suit != 's') {
                System.out.println(c1Suit + " is not a valid suit");
                return;
            }

            //card 2 Suit
            if (c2Suit != 'H' && c2Suit != 'C' && c2Suit != 'D' && c2Suit != 'S' && c2Suit != 'h' && c2Suit != 'c' && c2Suit != 'd' && c2Suit != 's') {
                System.out.println(c2Suit + " is not a valid suit");
                return;
            }

            //card 3 Suit
            if (c3Suit != 'H' && c3Suit != 'C' && c3Suit != 'D' && c3Suit != 'S' && c3Suit != 'h' && c3Suit != 'c' && c3Suit != 'd' && c3Suit != 's') {
                System.out.println(c3Suit + " is not a valid suit");
                return;
            }    
